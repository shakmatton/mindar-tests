...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    ...
    const portfolioItem0Video = await loadVideo("./paintandquest.mp4");
    ...
    const avatar = await loadGLTF('./softmind/scene.gltf');
    ...
    document.body.addEventListener('click', (e) => {
      ...
      // CHATGPT: Define an object that contains the functions for each clickable object
    ...
    const clickableFunctions = {
      ...
      webIcon: () => {
        ...
        textElement.innerHTML = "https://github.com/shakmatton/mindar-testes/lesson260.js";
      },
      emailIcon: () => {
        textObj.visible = true;
        textElement.innerHTML = "shak [at] gmail";
      },
      profileIcon: () => {
        textObj.visible = true;
        textElement.innerHTML = "https://shak.com";
      },
      locationIcon: () => {
        textObj.visible = true;
        textElement.innerHTML = "Earth, Solar System";
      }
    };

    // Use the object to call the appropriate function based on the object clicked
    if (o.userData.clickable) {
      // Get the name of the object clicked
      const name = o.name;
      // Check if the name is a valid key in the object
      if (name in clickableFunctions) {
        // Call the corresponding function
        clickableFunctions[name]();
      }
    }
